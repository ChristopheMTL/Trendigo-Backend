...
namespace IMS.Common.Core.Services
{
    public class CardPointHistoryService
    {
        ...
        public CardPointHistory AddCardPointHistory(long cardId, int points, long? promocodeId, string reason, string transaxId, long createdBy, IMSEntities db)
        {
            CardPointHistory cardHistory = new CardPointHistory();
            cardHistory.IMSCardId = cardId;
